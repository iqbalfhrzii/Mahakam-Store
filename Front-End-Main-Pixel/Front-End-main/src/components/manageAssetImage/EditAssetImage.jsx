...
function EditNewImage() {
  ...
  // Fetch categories based on userId
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      let uploadUrlImage = image.uploadUrlImage;

      if (typeof uploadUrlImage === "object" && uploadUrlImage) {
          ...
          {alertError && (
            ...
            >
              <div className="flex items-center justify-center space-x-2">
                ...
                <span>
                  Gagal menambahkan kategori baru, silahkan coba lagi.
                </span>
              </div>
            </div>
          )}
