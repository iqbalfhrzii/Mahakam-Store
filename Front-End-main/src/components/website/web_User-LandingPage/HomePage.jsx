  ...
  return (
    <div className="dark:bg-neutral-20 text-neutral-10 dark:text-neutral-90 min-h-screen font-poppins bg-primary-100 ">
      ...
      <div className="bg-primary-100 dark:bg-neutral-20 z-10 flex justify-center items-center img.ml-5">
        <img
          className="w-[1500px] mt-[10px] sm:mt-[30px] md:mt-[10px] lg:mt-[30px] xl:mt-[40px] 2xl:mt-[0px]"
          src={BannerBG}
          alt="Banner"
        />
      </div>
      ...
      <div className="absolute">
        <div className="bg-primary-100 dark:bg-neutral-20 text-neutral-10 dark:text-neutral-90 sm:bg-none md:bg-none lg:bg-none xl:bg-none 2xl:bg-none fixed  left-[50%] sm:left-[40%] md:left-[45%] lg:left-[50%] xl:left-[44%] 2xl:left-[50%] transform -translate-x-1/2 z-20 sm:z-40 md:z-40 lg:z-40 xl:z-40 2xl:z-40  flex justify-center top-[253px] sm:top-[20px] md:top-[20px] lg:top-[20px] xl:top-[20px] 2xl:top-[20px] w-full sm:w-[200px] md:w-[200px] lg:w-[100px] xl:w-[600px] 2xl:w-[1000px] -mt-0 sm:mt-0 md:mt-0 lg:mt-0 xl:mt-0 2xl:mt-0">
          <div className="flex justify-center my-[-40px] z-40">
            <form
